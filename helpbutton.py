...
add_paragraph(help_box, "Debes encontrar un compañero con quien jugar.")
add_paragraph(help_box, "Consigue los ocho puntos para obtener el consenso.")
add_paragraph(help_box, "El carro verde se controla con las flechas.", icon="flechitas")
add_paragraph(help_box, "El carro rojo se controla con: W A S D.", icon="wasd")
add_paragraph(help_box, "Si los carros chocan entre sí, no hay ganador.")
